package com.app.okra.bluetooth.operation;
...
import com.app.okra.bluetooth.otherlib.utils.HexUtil;
...
public class CharacteristicOperationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ble_characteric_operation, null);
        initView(v);
        return v;
    }
    ...
    public void showData() {
        ...
        System.out.println("::::: UUID: "+characteristic.getUuid().toString()  +",  CharaProp: "+charaProp);
        ...
        if (childList.contains(child)) {
            ...
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_ble_characteric_operation, null);
            ...
            switch (charaProp) {
                case PROPERTY_READ: {
                    View view_add = LayoutInflater.from(getActivity()).inflate(R.layout.layout_ble_characteric_operation_button, null);
                ...
                case PROPERTY_WRITE_NO_RESPONSE: {
                    View view_add = LayoutInflater.from(getActivity()).inflate(R.layout.layout_ble_characteric_operation_et, null);
                    final EditText et = (EditText) view_add.findViewById(R.id.et);
                    Button btn = (Button) view_add.findViewById(R.id.btn);
                    btn.setText(getActivity().getString(R.string.write));
                    btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (btn.getText().toString().equals(getActivity().getString(R.string.open_notification))) {
                                ...
                                System.out.println("::::: Notify Data: Service UUID:"+characteristic.getService().getUuid()+
                                        ", Charecterstics UUID: "+characteristic.getUuid().toString());
                                BleManager.getInstance().notify(
                                        ...
                                        new BleNotifyCallback() {
                                            ...
                                            public void onNotifyFailure(final BleException exception) {
                                                System.out.println("::::: Notify Failure: Exception- "+exception);
                                            ...
                                            public void onCharacteristicChanged(byte[] data) {
                                                System.out.println("::::: Notify onCharacteristicChanged- "+characteristic.getValue());
