...
package com.app.okra.bluetooth.otherlib.bluetooth;
...
import com.app.okra.bluetooth.otherlib.callback.BleIndicateCallback;
import com.app.okra.bluetooth.otherlib.callback.BleMtuChangedCallback;
import com.app.okra.bluetooth.otherlib.callback.BleNotifyCallback;
import com.app.okra.bluetooth.otherlib.callback.BleReadCallback;
import com.app.okra.bluetooth.otherlib.callback.BleRssiCallback;
import com.app.okra.bluetooth.otherlib.callback.BleWriteCallback;
import com.app.okra.bluetooth.otherlib.data.BleMsg;
import com.app.okra.bluetooth.otherlib.data.BleWriteState;
import com.app.okra.bluetooth.otherlib.exception.GattException;
import com.app.okra.bluetooth.otherlib.exception.OtherException;
import com.app.okra.bluetooth.otherlib.exception.TimeoutException;
...
public class BleConnector {
    ...
    public static final String UUID_CLIENT_SERVICE_DESCRIPTOR = "0000FFE0-0000-1000-8000-00805f9b34fb";
    public static final String UUID_CLIENT_CHARACTERISTIC_DESCRIPTOR = "0000FFE4-0000-1000-8000-00805f9b34fb";
    public static final String UUID_CLIENT_WRITE_SERVICE_DESCRIPTOR = "0000FFE5-0000-1000-8000-00805f9b34fb";
    public static final String UUID_CLIENT_WRITE_CHARACTERISTIC_DESCRIPTOR = "0000FFE9-0000-1000-8000-00805f9b34fb";
    ...
    public static UUID formUUID(String uuid) {
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        if (useCharacteristicDescriptor) {
            System.out.println(":::: characteristic.getDescriptor 1: "+characteristic.getUuid());
            descriptor = characteristic.getDescriptor(characteristic.getUuid());
        } else {
            System.out.println(":::: characteristic.getDescriptor 2: "+formUUID(UUID_CLIENT_CHARACTERISTIC_CONFIG_DESCRIPTOR));
        ...
        if (descriptor == null) {
            ...
            System.out.println("::::: notification set:"+(enable ? BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE :
                    BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE));
            descriptor.setValue(enable ? BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE :
                    BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE);
            boolean success2 = gatt.writeDescriptor(descriptor);
            System.out.println("::::: writeDescriptor 1 :"+(success2));
    ...
    private boolean setCharacteristicIndication(BluetoothGatt gatt,
        ...
        if (descriptor == null) {
            ...
            System.out.println("::::: writeDescriptor 2:"+(success2));
