...
import com.app.okra.bluetooth.otherlib.callback.BleGattCallback;
...
import com.app.okra.bluetooth.otherlib.data.BleConnectStateParameter;
import com.app.okra.bluetooth.otherlib.data.BleDevice;
import com.app.okra.bluetooth.otherlib.data.BleMsg;
import com.app.okra.bluetooth.otherlib.exception.ConnectException;
...
import com.app.okra.bluetooth.otherlib.utils.BleLog;
...
public class BleBluetooth {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
           ...
           BluetoothGattCharacteristic bleChar=  bluetoothGatt.getService(BleConnector.formUUID(BleConnector.UUID_CLIENT_SERVICE_DESCRIPTOR))
                    .getCharacteristic(BleConnector.formUUID(BleConnector.UUID_CLIENT_CHARACTERISTIC_DESCRIPTOR));
            bluetoothGatt.readCharacteristic(bleChar);
            bluetoothGatt.setCharacteristicNotification(bleChar, true);
            bleChar.setValue(new byte[]{01});
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            ...
            System.out.println("::::: Descriptor Write: ");
            Iterator iterator = bleNotifyCallbackHashMap.entrySet().iterator();
            while (iterator.hasNext()) {
                Map.Entry entry = (Map.Entry) iterator.next();
                Object callback = entry.getValue();
