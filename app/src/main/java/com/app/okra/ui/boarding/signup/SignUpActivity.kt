...
class SignUpActivity : BaseActivity(), View.OnClickListener, TextWatcher {
    ...
    private fun setView() {
        ...
        span.setSpan(signInOptionClick, 22, tvAlreadyHave.text.length, Spanned.SPAN_EXCLUSIVE_INCLUSIVE)
        span.setSpan(
        ...
        span.setSpan(
                ...
                22, tvAlreadyHave.text.length, Spanned.SPAN_EXCLUSIVE_INCLUSIVE
        )
